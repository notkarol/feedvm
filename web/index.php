...
foreach ($events as $event)
{
  ...
  echo '<a' . (is_favorite($DB_CONN, $event['event_id']) ? ' style="background: #FCCA4C; border-color: #C66D0E; color: #C66D0E;" ' : ' ') . ' href="index.php?id=' . $event['event_id'] . '&title=' . $event['name'] . '&start_time=' . $event['start_time'] . '&end_time=' . $event['end_time'] . '&food=' . $event['food'] . '&location=' . $event['location'] . ' ">★</a>' . "\n";
